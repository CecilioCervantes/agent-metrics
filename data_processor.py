...
def get_daily_time_goals(report_date):
    ...
    if weekday in [0, 1, 2, 3]:
        ...
        return goal_time, 2 + 20/60, wrap_limit, 4.5, "08:15"
    ...
    # Friday
        ...
        return goal_time, 2.0, wrap_limit, 3.5, "08:15"
...
def classify_office(agent_name):
    commercial_agents = {
        "sp tony", "sp allan", "sp chris", "sp jennifer", "sp mathew", "sp steve", "w retano"
    }
