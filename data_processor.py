...
def get_daily_time_goals(report_date):
    ...
    if weekday in [0, 1, 2, 3]:
        ...
        goal_time = 10.75 if is_prime else 10.25
        return goal_time, 2 + 20/60, wrap_limit, 4.5, "07:45"
    ...
    # Saturday
        ...
        wrap_limit = 0.75
        return 6, 1, wrap_limit, 2.75, "07:45"
...
def classify_office(agent_name):
    commercial_agents = {
        "sp tony", "sp allan", "sp chris", "sp mathew", "sp steve", "w retano", "sp jennifer1", "sp tom1", "sp smith"
    }
